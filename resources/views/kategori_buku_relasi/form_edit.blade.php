            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-10 pd-sm-20 bg-gray-100">
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                          <select name="kategori_id" class="form-control select2" id="">
                                              <option value="{{ $dt->kategori_id }}" selected>{{$dt->kategori->nama_kategori}}</option>
                                              @foreach ($dtKategori as $dtKategori)
                                                <option value="">Pilih Kategori Buku</option>
                                                <option value="{{ $dtKategori->id }}">{{ $dtKategori->nama_kategori }}</option>
                                            @endforeach
                                          </select>
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                          <select name="buku_id" class="form-control select2" id="">
                                              <option value="{{ $dt->buku_id }}" selected>{{$dt->buku->judul}}</option>
                        ...
                        <a href="{{ route('kategori_buku_relasi.index') }}" class="btn btn-secondary pd-x-30 mg-t-5">
