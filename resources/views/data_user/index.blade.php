                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex my-auto btn-list justify-content-end">
                                <a class="modal-effect btn-sm btn btn-info" data-bs-effect="effect-rotate-left" data-bs-toggle="modal" href="#modaldemo9"><i class="fa fa-plus"></i> Tambah</a>
                        ...
                        <table id="tbl_list" class="table table-sm table-striped table-bordered tx-14" width="100%">
                            ...
                            @foreach($dtUser as $dt)
                                <tr>
                                    ...
                                    <td>
                                        <a class="modal-effect btn-sm btn btn-info" data-bs-effect="effect-rotate-left" data-bs-toggle="modal" href="#modaldemo9{{ $dt->id }}"><i class="fa fa-edit"></i></a>
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('data_user.destroy', $dt->id) }}" method="POST" class="d-inline" >
                                            @csrf
                                            @method('DELETE')
