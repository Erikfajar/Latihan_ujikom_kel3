...
<body class="main-body app sidebar-mini ltr">
    ...
    <div class="page custom-index">
        ...
        <div class="main-footer ht-45">
            <div class="container-fluid pd-t-0-f ht-100p">
                <span> Copyright © 2022 <a href="javascript:void(0);" class="text-primary">Azira</a>. Designed with
    ...
    <script src="{{ asset('back/js/rangeslider.js') }}"></script>
    ...
    <script src="{{ asset('') }}back/plugins/datatable/js/dataTables.bootstrap5.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/js/dataTables.buttons.min.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/js/buttons.bootstrap5.min.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/js/jszip.min.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/pdfmake/pdfmake.min.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/pdfmake/vfs_fonts.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/js/buttons.html5.min.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/js/buttons.print.min.qjs"></script>
    <script src="{{ asset('') }}back/plugins/datatable/js/buttons.colVis.min.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/dataTables.responsive.min.js"></script>
    <script src="{{ asset('') }}back/plugins/datatable/responsive.bootstrap5.min.js"></script>
	<script src="{{ asset('') }}back/js/table-data.js"></script>
