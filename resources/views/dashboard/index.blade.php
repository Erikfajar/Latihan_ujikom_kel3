                    ...
                    <div class="card overflow-hidden project-card">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="project-content">
                                    <h4 class="card-title mg-b-10"> Data Pengembalian</h4>
                                    <ul>
                                        <li>
                                            <strong>Total</strong>
                                            <span>2</span>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-10">Peminjaman & Pengembalian Buku</h4>
                                <i class="mdi mdi-dots-horizontal text-gray"></i>
                            </div>
                            <p class="tx-12 text-muted mb-2">Peminjaman buku adalah proses dimana taruna/guru meminjam buku- buku 
                                untuk dibaca dirumah dengan batas waktu yang telah ditentukan. <a href="">Learn more</a></p>
                        </div>
                        <div class="card-body pd-y-7">
                            <div class="area chart-legend mb-0">
                                <div>
                                    <i class="mdi mdi-album text-primary me-4"></i> Total Data Peminjaman
                                </div>
                                <div>
                                    <i class="mdi mdi-album text-pink me-4"></i> Total Data Pengembalian
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
								<div class="card card-dashboard-events">
									<div class="card-header pb-0">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10 "> Data Peminjaman & Pengembalian</h4>
											<i class="mdi mdi-dots-horizontal text-gray"></i>
										</div>
										<p class="tx-12 text-muted mb-0">The Amount of Data on Borrowing and Returning Books.<a href="">Learn more</a> </p>
									</div>
									<div class="p-4">
										<div class="">
											<div class="row">
												<div class="col-md-6 col-6 text-center">
													<div class="task-box primary mb-0">
														<p class="mb-0 tx-12">Total Peminjaman</p>
														<h3 class="mb-0">385</h3>
													</div>
												</div>
												<div class="col-md-6 col-6 text-center">
													<div class="task-box danger  mb-0">
														<p class="mb-0 tx-12">Total Pengembalian</p>
														<h3 class="mb-0">19</h3>
													</div>
												</div>
											</div>
                                    ...
                                    <div class="task-stat pb-0">
										<div class="d-flex tasks">
											<div class="mb-0">
												<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-primary me-2"></i>Already Returned</div>
										...
										<div class="d-flex tasks">
											<div class="mb-0">
												<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink me-2"></i> Not Returned</div>
												<span class="text-muted tx-11 ms-4">8:00am - 10:30am</span>
											</div>
