				...
				<div class="sign-up-body wd-md-50p">
					<div class="main-signin-header">
                        ...
                        <form method="POST" action="{{ route('auth') }}">
                            ...
                            <button style="margin-left: 1em" type="submit" class="btn btn-primary"><i class="fe fe-log-in"></i> Sign In</button>
                            <button type="submit" class="btn btn-info"><i class="fe fe-log-in"></i> Sign Up</button>
